...
public class JsonWebAlgorithm {
  ...
  public static String toJca(final String jwa) {
    if (INSTANCE.jwaJcaMap.get(jwa) != null) {
      ...
      throw new WebApplicationException("algorithm " + jwa + " is not supported");
    }
  }
   ...
   *          curve name
   */
  private void putEcIfAvailable(final String jwa, final String jca, final NamedEllipticCurve crv) {
   ...
   */
  private void putEncIfAvailable(final String jwa, final String jca, final String jcaMac, final int keySize,
      final int ivLen) {
