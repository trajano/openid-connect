 ...
 *             {@link net.trajano.openidconnect.crypto.JsonWebKeySet}
 */
@Deprecated
public class JsonWebKeySet {
    ...
    private PublicKey buildRSAPublicKey(final JsonObject keyJson) throws GeneralSecurityException {
        ...
        final BigInteger modulus = new BigInteger(1, Base64Url.decode(keyJson.getString("n")));
        final BigInteger publicExponent = new BigInteger(1, Base64Url.decode(keyJson.getString("e")));
    ...
    public <T extends Key> T getKey(final String kid,
            final Class<T> clazz) {
